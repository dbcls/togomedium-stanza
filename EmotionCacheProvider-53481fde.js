import { r as reactExports, h as hasOwnProperty, E as Emotion, a as createEmotionProps, _ as _extends, m as memoize$1, w as withEmotionCache, T as ThemeContext$2, g as getRegisteredStyles, s as serializeStyles, b as registerStyles, u as useInsertionEffectAlwaysWithSyncFallback, i as insertStyles, c as css, G as Global, C as CacheProvider, d as createCache } from './index-56cafe6b.js';
import { o as objectAssign, g as getDefaultExportFromCjs } from './stanza-bd712360.js';
 ...
 * LICENSE file in the root directory of this source tree.
 */
var aa=reactExports,m=objectAssign,r=schedulerExports;function y(a){for(var b="https://reactjs.org/docs/error-decoder.html?invariant="+a,c=1;c<arguments.length;c++)b+="&args[]="+encodeURIComponent(arguments[c]);return "Minified React error #"+a+"; visit "+b+" for the full message or use the non-minified dev environment for full errors and additional helpful warnings."}if(!aa)throw Error(y(227));var ba=new Set,ca={};function da(a,b){ea(a,b);ea(a+"Capture",b);}
...
const EmotionCacheProvider = ({ children }) => {
    ...
    return (jsxs(CacheProvider, Object.assign({ value: myCache }, { children: [jsx(EmotionGlobalStyles, {}), jsx("div", Object.assign({ ref: containerRef }, { children: children }))] })));
};

export { createTheme$1 as A, styleFunctionSx$1 as B, COLOR_PRIMARY as C, useTheme$1 as D, EmotionCacheProvider as E, Fragment as F, defaultSxConfig$1 as G, isPlainObject as H, lighten as I, darken as J, COLOR_GRAY400 as K, COLOR_GRAY as L, ReactDOM as R, SIZE1 as S, ThemeContext$1 as T, _objectWithoutPropertiesLoose as _, jsxs as a, jsxRuntimeExports as b, useTheme as c, createTheme as d, COLOR_WHITE as e, FONT_EN as f, COLOR_GRAY300 as g, COLOR_TEXT as h, capitalize as i, jsx as j, alpha as k, COLOR_GRAY_BG as l, ROUNDED_CORNER as m, newStyled as n, SIZE2 as o, SIZE05 as p, FONT_WEIGHT_MEDIUM as q, COLOR_GRAY_LINE as r, FONT_WEIGHT_BOLD as s, SIZE3 as t, useTheme$2 as u, COLOR_GRAY700 as v, SIZE4 as w, reactDomExports as x, formatMuiErrorMessage as y, deepmerge as z };
//# sourceMappingURL=EmotionCacheProvider-53481fde.js.map
