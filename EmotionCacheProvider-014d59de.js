import { r as react, h as hasOwnProperty, E as Emotion, a as createEmotionProps, m as memoize$1, w as withEmotionCache, T as ThemeContext$2, g as getRegisteredStyles, s as serializeStyles, i as insertStyles, _ as _extends, c as css, R as React, G as Global, C as CacheProvider, b as createCache } from './index-6aec0cc7.js';
import { o as objectAssign, b as createPopper } from './stanza-f44e302d.js';
...
const _excluded$a = ["anchorEl", "children", "direction", "disablePortal", "modifiers", "open", "placement", "popperOptions", "popperRef", "TransitionProps"],
...
const SIZE_BASE = 8;
const SIZE05 = `${SIZE_BASE / 2}px`;
const SIZE1 = `${SIZE_BASE}px`;
const SIZE2 = `${SIZE_BASE * 2}px`;
const SIZE3 = `${SIZE_BASE * 3}px`;
const SIZE4 = `${SIZE_BASE * 4}px`;
const FONT_DEFAULT = css `
  font-family: ${FONT_EN};
  font-size: 14px;
`;
const FONT_WEIGHT_BOLD = css `
  font-weight: 700;
`;
...
const EmotionGlobalStyles = () => {
    return jsx(Global, { styles: styles }, void 0);
};
const styles = css `
  * {
    ${FONT_DEFAULT};
...
const EmotionCacheProvider = ({ children }) => {
    ...
    const createMyCache = () => createCache({
        key: "stanza",
        container: containerRef.current,
    });
    const [myCache, setMyCache] = react.exports.useState(createMyCache);
    react.exports.useEffect(() => setMyCache(createMyCache), []);
    return (jsxs(CacheProvider, Object.assign({ value: myCache }, { children: [jsx(EmotionGlobalStyles, {}, void 0), jsx("div", Object.assign({ ref: containerRef }, { children: children }), void 0)] }), void 0));
};

export { FONT_WEIGHT_MEDIUM as $, newStyled as A, generateUtilityClass as B, COLOR_WHITE as C, generateUtilityClasses as D, EmotionCacheProvider as E, FONT_EN as F, styled$1 as G, alpha as H, useThemeProps as I, useTheme as J, clsx as K, composeClasses as L, Grow$1 as M, propToStyleFunction as N, isPlainObject as O, Popper$1 as P, useTheme$3 as Q, ReactDOM as R, SIZE1 as S, ThemeContext$1 as T, useTheme$1 as U, rootShouldForwardProp as V, resolveProps as W, ROUNDED_CORNER as X, SIZE2 as Y, SIZE05 as Z, _objectWithoutPropertiesLoose as _, SIZE4 as a, FONT_WEIGHT_BOLD as a0, COLOR_GRAY300 as a1, COLOR_GRAY400 as a2, COLOR_GRAY_BG as a3, createTheme as a4, Portal$1 as a5, _inheritsLoose as a6, TransitionGroupContext as a7, duration as a8, Transition$1 as a9, reflow as aa, getTransitionProps as ab, defaultTheme$1 as ac, formatMuiErrorMessage as ad, deepmerge as ae, slotShouldForwardProp as af, lighten as ag, darken as ah, SIZE3 as b, jsxs as c, COLOR_GRAY700 as d, COLOR_PRIMARY as e, COLOR_GRAY as f, Fragment as g, COLOR_GRAY_LINE as h, isHostComponent as i, jsx as j, capitalize as k, createChainedFunction as l, createSvgIcon as m, debounce as n, isMuiElement as o, ownerDocument as p, ownerWindow as q, useId as r, setRef as s, useControlled as t, useEnhancedEffect$1 as u, useEventCallback as v, useForkRef as w, useIsFocusVisible as x, ClassNameGenerator$1 as y, jsxRuntime as z };
//# sourceMappingURL=EmotionCacheProvider-014d59de.js.map
